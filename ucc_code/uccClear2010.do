...
gen EDUCA = 1 if 0  | inlist(UCC,660110,660210,660410,660901,660902,670110,670210,670410,670901,670902);
...
gen OTHENT = 1 if 0  | inlist(UCC,520901,520904,520907,600110,600121,600122,600132,600141,600142,600210,600310,600410,600420,600430,600901,600902,610210,610230,620320,620330,620905,620906,620908,620909,620919,620921,620922,620930,680310);
replace OTHENT = 0 if OTHENT==.;
gen PETTOY = 1 if 0  | inlist(UCC,610120,610320,620410,620420);
replace PETTOY = 0 if PETTOY==.;
gen OTHEQP = 1 if 0  | PETTOY | OTHENT;
replace OTHEQP = 0 if OTHEQP==.;
gen TVRDIO = 1 if 0  | inlist(UCC,270310,270311,310140,310210,310220,310230,310240,310311,310313,310314,310320,310333,310334,310340,310350,340610,340902,340905,610130,690320,690330,690340,690350,620904);
...
gen MISCEQ = 1 if 0  | inlist(UCC,320120,320130,320150,320210,320220,320231,320232,320233,320410,320420,320901,320902,320903,320904,340904,430130,690111,690112,690115,690210,690230,690241,690242,690243,690244,690245);
...
gen FLRCVR = 1 if 0  | inlist(UCC,230133,230134,320111,320163);
...
gen OTHLOD = 1 if 0  | inlist(UCC,210210,210310,210902,220122,220212,220312,220314,220322,220902,230123,230152,230902,240113,240123,240214,240223,240313,240323,320613,320623,320633,340912,880310,990940,680905);
