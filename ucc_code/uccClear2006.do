...
gen EDUCA = 1 if 0  | inlist(UCC,660110,660210,660900,660901,660902,670110,670210,670901,670902);
...
gen VRNTLO = 1 if 0  | inlist(UCC,450310,450313,450314,450410,450413,450414,061520110,061520111,061520112,520310,520410,520511,520512,520521,520522,520531,520532,520541,520542,520550,520560,520902,061520903,520905,061520906,620113);
