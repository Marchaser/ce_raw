...
gen CASHCO = 1 if 0  | inlist(UCC,800801,800810,800820,800830,800840,800850,800860);
replace CASHCO = 0 if CASHCO==.;
gen MISC2 = 1 if 0  | inlist(UCC,710110,900001);
replace MISC2 = 0 if MISC2==.;
gen MISC1 = 1 if 0  | inlist(UCC,620112,680110,680140,680210,680220,680901,680902,790600,880210);
...
gen PERSCA = 1 if 0  | inlist(UCC,640130,640420,650110,650210,650900);
...
gen TVRDIO = 1 if 0  | inlist(UCC,270310,310110,310120,310130,310210,310220,310230,310311,310312,310313,310320,310330,310333,310334,310341,310342,340610,340902,340905,610130,620904,620912);
...
gen OTHHEX = 1 if 0  | inlist(UCC,330511,340510,340620,340630,340901,340907,340908,690113,690114,990900);
...
gen OTHLOD = 1 if 0  | inlist(UCC,210210,210310,210902,220112,220122,220212,220312,220314,220322,220902,230123,230152,230902,240113,240123,240214,240223,240313,240323,320613,320623,320633,340912,880310,990940,230119);
