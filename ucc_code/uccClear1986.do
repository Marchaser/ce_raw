...
gen SHELT = 1 if 0  | inrange(UCC,210110,220322) | inrange(UCC,220901,230116) | inrange(UCC,230119,230123) | inrange(UCC,230141,240323) | inrange(UCC,320611,320633) | inrange(UCC,340911,350110) | inrange(UCC,690241,690245) | inlist(UCC,800710,790600,790690) | inrange(UCC,990910,990950);
replace SHELT = 0 if SHELT==.;
gen HOUS = 1 if 0  | inrange(UCC,210110,220322) | inrange(UCC,220901,270214) | inrange(UCC,270411,300412) | inrange(UCC,320110,340530) | inrange(UCC,340620,340901) | inrange(UCC,340903,340904) | inrange(UCC,340906,350110) | inlist(UCC,430130,670310) | inrange(UCC,690110,690245) | inlist(UCC,790600,790690) | inrange(UCC,990900,990950) | inlist(UCC,800710);
...
gen FDAWAY = 1 if 0  | inrange(UCC,190901,190904) | inlist(UCC,790410,800700,790430);
replace FDAWAY = 0 if FDAWAY==.;
gen FDHOME = 1 if 0  | inlist(UCC,790220,790230);
...
gen TOTEXP = 1 if 0  | inrange(UCC,190901,220322) | inrange(UCC,790220,790600) | inrange(UCC,220901,450110) | inlist(UCC,450210,450220,460110) | inrange(UCC,460901,460902) | inrange(UCC,470111,600122) | inrange(UCC,600131,600132) | inrange(UCC,600210,710110) | inlist(UCC,790690,850300,900001) | inrange(UCC,990900,990950) | inrange(UCC,800700,800710) | inlist(UCC,800801) | inrange(UCC,800810,800940) | inlist(UCC,002120);
