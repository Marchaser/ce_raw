...
gen EDUCA = 1 if 0  | inlist(UCC,660110,660210,660901,660902,670110,670210,670901,670902);
...
gen TVRDIO = 1 if 0  | inlist(UCC,270310,310140,310210,310220,310230,310240,310311,310313,310314,310320,310333,310334,310340,310350,340610,340902,340905,610130,620904,620912);
...
gen BOYFIF = 1 if 0  | inlist(UCC,370110,370120,370130,370211,370212,370213,370220,370311,370312,370313,370902,370903,370904);
...
gen MISCEQ = 1 if 0  | inlist(UCC,320120,320130,320150,320210,320220,320231,320232,320410,320420,320901,320902,320903,320904,340904,430130,690111,690112,690115,690210,690230,690241,690242,690243,690244,690245);
...
gen TELEPH = 1 if 0  | inlist(UCC,270101,270102,270104);
...
gen OTHLOD = 1 if 0  | inlist(UCC,210210,210310,210902,220122,220212,220312,220314,220322,220902,230123,230152,230902,240113,240123,240214,240223,240313,240323,320613,320623,320633,340912,880310,990940);
